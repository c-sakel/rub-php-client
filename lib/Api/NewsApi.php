...
class NewsApi
{
    ...
    {
        list($response) = $this->newsIndexWithHttpInfo();
        return $response;
    }

    /**
     * Operation newsIndexWithHttpInfo
     *
     * Alle News abrufen
     *
     *
     ...
     */
    public function newsIndexAsync()
    {
        return $this->newsIndexAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation newsIndexAsyncWithHttpInfo
     *
     * Alle News abrufen
     *
     *
    ...
    /**
     * Create request for operation 'newsIndex'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function newsIndexRequest()
    {
    ...
    {
        list($response) = $this->newsShowWithHttpInfo($news);
        return $response;
    }

    /**
     * Operation newsShowWithHttpInfo
     *
     * Einzelne News abrufen
     *
     * @param  int $news News-ID, welche abgerufen werden soll (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function newsShowAsync($news)
    {
        return $this->newsShowAsyncWithHttpInfo($news)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation newsShowAsyncWithHttpInfo
     *
     * Einzelne News abrufen
     *
     * @param  int $news News-ID, welche abgerufen werden soll (required)
    ...
    /**
     * Create request for operation 'newsShow'
     *
     * @param  int $news News-ID, welche abgerufen werden soll (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function newsShowRequest($news)
    {
        // verify the required parameter 'news' is set
        if ($news === null || (is_array($news) && count($news) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $news when calling newsShow'
            );
        }

        $resourcePath = '/news/show';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($news !== null) {
            $queryParams['news'] = ObjectSerializer::toQueryValue($news, null);
        }
