...
class TeamspeakInstanceApi
{
     ...
     * @throws \csakel\RUBClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \csakel\RUBClient\Model\TeamspeakInstance[]
     */
     ...
     * @throws \csakel\RUBClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \csakel\RUBClient\Model\TeamspeakInstance[], HTTP status code, HTTP response headers (array of strings)
     */
    public function teamspeakInstanceIndexWithHttpInfo()
    {
        $returnType = '\csakel\RUBClient\Model\TeamspeakInstance[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\csakel\RUBClient\Model\TeamspeakInstance[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
