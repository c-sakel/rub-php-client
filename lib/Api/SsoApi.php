...
class SsoApi
{
     ...
     * @return \csakel\RUBClient\Model\SsoHash[]
     */
     ...
     * @throws \csakel\RUBClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \csakel\RUBClient\Model\SsoHash[], HTTP status code, HTTP response headers (array of strings)
     */
    public function ssoCreateWithHttpInfo($username, $ip_address, $url = null)
    {
        $returnType = '\csakel\RUBClient\Model\SsoHash[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\csakel\RUBClient\Model\SsoHash[]',
