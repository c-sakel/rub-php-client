...
# **domainCreate**
> \Swagger\Client\Model\Domain[] domainCreate($domain_name, $owner_c, $admin_c, $tech_c, $zone_c, $ns1, $ns2, $ns3, $ns4, $ns5, $authinfo, $create_zone)
...
# **domainDelete**
> \Swagger\Client\Model\Domain[] domainDelete($domain_name, $date)
...
# **domainIndex**
> \Swagger\Client\Model\Domain[] domainIndex()
...
> \Swagger\Client\Model\Domain[] domainRegistryStatus($domain_name, $status)
...
> \Swagger\Client\Model\Domain[] domainResendVerificationEmail($domain_name)
...
# **domainRestore**
> \Swagger\Client\Model\Domain[] domainRestore($domain_name)
...
# **domainShow**
> \Swagger\Client\Model\Domain[] domainShow($domain_name)
...
# **domainUndelete**
> \Swagger\Client\Model\Domain[] domainUndelete($domain_name)
...
# **domainUpdate**
> \Swagger\Client\Model\Domain[] domainUpdate($domain_name, $owner_c, $admin_c, $tech_c, $zone_c, $ns1, $ns2, $ns3, $ns4, $ns5)
