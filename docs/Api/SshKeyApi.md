...
# **sshKeyCreate**
> \csakel\RUBClient\Model\SshKey[] sshKeyCreate($name, $ssh_public_key)
...
$apiInstance = new csakel\RUBClient\Api\SshKeyApi(
...
[**\csakel\RUBClient\Model\SshKey[]**](../Model/SshKey.md)
...
# **sshKeyDelete**
> \csakel\RUBClient\Model\SshKey[] sshKeyDelete($ssh_key_id)
...
# **sshKeyIndex**
> \csakel\RUBClient\Model\SshKey[] sshKeyIndex()
...
# **sshKeyShow**
> \csakel\RUBClient\Model\SshKey[] sshKeyShow($ssh_key_id)
