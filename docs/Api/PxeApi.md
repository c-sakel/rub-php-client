...
> \csakel\RUBClient\Model\PxeAction[] pxeInstallationCreate($mac_address, $template, $hostname, $password, $ssh_keys, $commands, $ip_addresses, $ip6_addresses)
...
$apiInstance = new csakel\RUBClient\Api\PxeApi(
...
> \csakel\RUBClient\Model\PxeAction[] pxeInstallationIndex()
...
# **pxeInstallationShow**
> \csakel\RUBClient\Model\PxeAction[] pxeInstallationShow($installation)
...
> \csakel\RUBClient\Model\PxeTemplate[] pxeInstallationTemplates()
