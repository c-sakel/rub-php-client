# Swagger\Client\DedicatedServerApi
...
> \Swagger\Client\Model\DedicatedServer[] dedicatedServerIndex()
...
$apiInstance = new Swagger\Client\Api\DedicatedServerApi(
...
[**\Swagger\Client\Model\DedicatedServer[]**](../Model/DedicatedServer.md)
...
> \Swagger\Client\Model\Vserver[] dedicatedServerReinstall($server_id, $template, $password, $ssh_keys, $commands, $raid_level)
...
> \Swagger\Client\Model\DedicatedServer[] dedicatedServerReset($server_id)
...
# **dedicatedServerShow**
> \Swagger\Client\Model\DedicatedServer[] dedicatedServerShow($server_id)
...
> \Swagger\Client\Model\DedicatedServer[] dedicatedServerStart($server_id)
...
> \Swagger\Client\Model\DedicatedServer[] dedicatedServerStatus($server_id)
...
# **dedicatedServerStop**
> \Swagger\Client\Model\DedicatedServer[] dedicatedServerStop($server_id)
...
> \Swagger\Client\Model\PxeTemplate[] dedicatedServerTemplates()
