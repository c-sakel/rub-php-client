...
# **vserverAddress**
> \csakel\RUBClient\Model\Address[] vserverAddress($server_id)
...
$apiInstance = new csakel\RUBClient\Api\VserverApi(
...
# **vserverCreate**
> \csakel\RUBClient\Model\Vserver[] vserverCreate($cores, $memory, $disk, $ip_addresses, $ip6_addresses, $backups, $template, $hostname, $password, $ssh_keys, $commands)
...
# **vserverDdosAlert**
> \csakel\RUBClient\Model\DdosAlert[] vserverDdosAlert($server_id)
...
# **vserverDelete**
> \csakel\RUBClient\Model\Vserver[] vserverDelete($server_id)
...
# **vserverIndex**
> \csakel\RUBClient\Model\Vserver[] vserverIndex()
...
# **vserverInstallation**
> \csakel\RUBClient\Model\PxeAction[] vserverInstallation($server_id)
...
# **vserverOperation**
> \csakel\RUBClient\Model\PxeAction[] vserverOperation($server_id)
...
# **vserverOperations**
> \csakel\RUBClient\Model\PxeTemplate[] vserverOperations($server_id)
...
# **vserverReinstall**
> \csakel\RUBClient\Model\Vserver[] vserverReinstall($server_id, $template, $hostname, $password, $ssh_keys, $commands, $ip_addresses, $ip6_addresses)
...
# **vserverRestart**
> \csakel\RUBClient\Model\Vserver[] vserverRestart($server_id)
...
# **vserverSettings**
> \csakel\RUBClient\Model\Vserver[] vserverSettings($server_id, $title, $hostname)
...
# **vserverShow**
> \csakel\RUBClient\Model\Vserver[] vserverShow($server_id)
...
# **vserverShutdown**
> \csakel\RUBClient\Model\Vserver[] vserverShutdown($server_id)
...
# **vserverStart**
> \csakel\RUBClient\Model\Vserver[] vserverStart($server_id)
...
# **vserverStatus**
> \csakel\RUBClient\Model\VserverStatus[] vserverStatus($server_id)
...
[**\csakel\RUBClient\Model\VserverStatus[]**](../Model/VserverStatus.md)
...
# **vserverStop**
> \csakel\RUBClient\Model\Vserver[] vserverStop($server_id)
...
# **vserverTemplates**
> \csakel\RUBClient\Model\PxeTemplate[] vserverTemplates()
...
# **vserverTraffic**
> \csakel\RUBClient\Model\VserverTraffic[] vserverTraffic($server_id, $start_date, $end_date, $group_by)
...
[**\csakel\RUBClient\Model\VserverTraffic[]**](../Model/VserverTraffic.md)
...
# **vserverUpgrade**
> \csakel\RUBClient\Model\Vserver[] vserverUpgrade($server_id, $cores, $memory, $disk, $ip_addresses, $ip6_addresses, $backups)
