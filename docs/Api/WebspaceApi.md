...
# **webspaceCreate**
> \Swagger\Client\Model\Webspace[] webspaceCreate($package)
...
$apiInstance = new Swagger\Client\Api\WebspaceApi(
...
[**\Swagger\Client\Model\Webspace[]**](../Model/Webspace.md)
...
# **webspaceIndex**
> \Swagger\Client\Model\Webspace[] webspaceIndex()
...
# **webspacePackages**
> \Swagger\Client\Model\WebspacePackage[] webspacePackages()
...
[**\Swagger\Client\Model\WebspacePackage[]**](../Model/WebspacePackage.md)
...
# **webspaceSettings**
> \Swagger\Client\Model\Webspace[] webspaceSettings($webspace_id, $description)
...
# **webspaceShow**
> \Swagger\Client\Model\Webspace[] webspaceShow($webspace_id)
...
# **webspaceSso**
> \Swagger\Client\Model\WebspaceSso[] webspaceSso($webspace_id, $client_ip)
...
[**\Swagger\Client\Model\WebspaceSso[]**](../Model/WebspaceSso.md)
...
# **webspaceUsage**
> \Swagger\Client\Model\WebspaceUsage[] webspaceUsage($webspace_id)
...
[**\Swagger\Client\Model\WebspaceUsage[]**](../Model/WebspaceUsage.md)
