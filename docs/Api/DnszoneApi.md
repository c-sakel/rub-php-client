...
# **dnsZoneGet**
> \csakel\RUBClient\Model\DnsZone[] dnsZoneGet()
...
$apiInstance = new csakel\RUBClient\Api\DnszoneApi(
...
[**\csakel\RUBClient\Model\DnsZone[]**](../Model/DnsZone.md)
...
> \csakel\RUBClient\Model\DnsZoneRecord[] dnsZoneRecordCreatePost($zone_name, $type, $content, $name, $priority, $ttl)
...
[**\csakel\RUBClient\Model\DnsZoneRecord[]**](../Model/DnsZoneRecord.md)
...
# **dnsZoneRecordGet**
> \csakel\RUBClient\Model\DnsZoneRecord[] dnsZoneRecordGet($zone_name)
...
> \csakel\RUBClient\Model\DnsZoneRecord[] dnsZoneRecordShowGet($zone_name, $record_id)
...
> \csakel\RUBClient\Model\DnsZoneRecord[] dnsZoneRecordUpdatePost($zone_name, $record_id, $type, $content, $name, $priority, $ttl)
...
# **dnsZoneShowGet**
> \csakel\RUBClient\Model\DnsZone[] dnsZoneShowGet($zone_name)
