# Swagger\Client\NetworkfirewallApi
...
> \Swagger\Client\Model\NetworkFirewall[] networkFirewallAssignPost($firewall_id, $vserver_id, $override)
...
$apiInstance = new Swagger\Client\Api\NetworkfirewallApi(
...
> \Swagger\Client\Model\NetworkFirewall[] networkFirewallCopyPost($firewall_id)
...
> \Swagger\Client\Model\NetworkFirewall[] networkFirewallCreatePost($title, $policy_in, $policy_out)
...
# **networkFirewallGet**
> \Swagger\Client\Model\NetworkFirewall[] networkFirewallGet()
...
> \Swagger\Client\Model\NetworkFirewallRule[] networkFirewallRuleCreatePost($firewall_id, $direction, $active, $description, $protocol, $port, $source_addresses, $destination_addresses)
...
[**\Swagger\Client\Model\NetworkFirewallRule[]**](../Model/NetworkFirewallRule.md)
...
> \Swagger\Client\Model\NetworkFirewallRule[] networkFirewallRuleUpdatePost($firewall_id, $rule_id, $active, $description, $protocol, $port, $source_addresses, $destination_addresses)
...
> \Swagger\Client\Model\NetworkFirewall[] networkFirewallShowGet($firewall_id)
...
> \Swagger\Client\Model\NetworkFirewall[] networkFirewallUnassignDelete($firewall_id, $vserver_id)
...
> \Swagger\Client\Model\NetworkFirewall[] networkFirewallUpdatePost($firewall_id, $title, $policy_in, $policy_out)
